                    ...
                    <div id="address" style="display: block">
                        <div class="address-list">
                            <c:forEach items="${userAddresses}" var="userAddress">
                                <c:if test="${userAddress.addressDefault==1}">
                                <div class="billing-address-bar mb-0 border-red">
                            ...
                            <c:forEach items="${userAddresses}" var="userAddress">
                                <c:if test="${userAddress.addressDefault==0}">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="order-details ml-15">
                        <div class="cart-totals mb-0">
                          <h3>购物车总计</h3>
                            <ul>
                                <li>小计 <span>${order.total}</span></li>
                                <li>运费 <span>$10.00</span></li>
                                <li>优惠券<span>$00.00</span></li>
                                <li>总计 <span>${order.total+10}</span></li>
                                <li><b>应付总额</b> <span><b>${order.total+10}</b></span></li>
                            </ul>
